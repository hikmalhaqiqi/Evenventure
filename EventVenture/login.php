    ...
    <header>
        <nav class="navbar">
            <ul class="list">
                ...
                <li class="register"><a href="daftarTenant.php" class ="tetep1" ><p>Daftar</p></a></li>
            </ul>
        </nav>
    </header>
    <main>
        <section class="container-login">
            <div class="left-part-login">
                <form method="POST" action="loginprocesTenant.php">
                    <h3>Login Tenant</h3>
                    ...
                    <button class="submit-signup">Sign In</button>
                </form>
            </div>
